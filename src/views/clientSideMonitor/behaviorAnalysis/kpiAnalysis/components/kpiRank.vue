          ...
          <el-col :span="6" class="comLang">
            <div class="grid-content bg-purple">
              ...
              >
                ...
                <el-table-column prop="company" width="140px" label="公司" align="center"></el-table-column>
                <el-table-column label="总KPI" width="200px" prop="KPICal" align="center">
                  <!-- 循环遍历显示百分百数值 -->
            ...
            <div class="grid-content bg-purple">
              ...
              >
                ...
                <el-table-column prop="KPIjianfen" label="环比" align="center" width="90px">
                  <template slot-scope="{ row }">
                    <div
                      v-if="row.KPILinkRatioJIANFEN.slice(0,row.KPILinkRatioJIANFEN.length-1) > 0"
                    >
                      <img src="@/assets/up.png" class="sequentialImg" />
            ...
            <div class="grid-content bg-purple">
              ...
              >
                ...
                <el-table-column
                  ...
                  align="center"
                ></el-table-column>
                <el-table-column label="总KPI" width="220px" prop="KPICal" align="center">
                  <!-- 循环遍历显示百分百数值 -->
                  <template slot-scope="{ row }">
                    <el-progress
                      :percentage="row.KPI/10"

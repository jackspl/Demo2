  ...
  },
  {
    ...
    children: [{
      ...
      },
      {
        ...
        path: 'survey',
        name: 'surveySum',
        component: () => import('../views/serverMonitor/serviceFile/survey.vue')
      },
      {
        // 服务器监控——服务——趋势分析
        path: 'trendAnalysisUnit',
        name: 'trendAnalysisUnit',
        component: () => import('../views/serverMonitor/serTrenUnit/survey.vue')
      },
      {
        // 服务器监控——服务——趋势分析
        path: 'detAnalysisUnit',
        name: 'detAnalysisUnit',
        component: () => import('../views/serverMonitor/detTrenUnit/survey.vue')
      },
      {
        // 主机监控——服务——概况
        path: 'hostIndex',
        name: 'hostIndex',
        component: () => import('../views/serverMonitor/hostFile/hostIndex.vue')
      },
      {
        // 主机监控——服务——趋势分析
        path: 'hostTrend',
        name: 'hostTrend',
        component: () => import('../views/serverMonitor/hostTrendFile/hostTrend.vue')
      },
      {
        // 主机监控——服务——详情
        path: 'hostDet',
        name: 'hostDet',
        component: () => import('../views/serverMonitor/hostDetFile/hostDet.vue')
      },
      {
        // 管理——用户
        path: 'manage',
        name: 'manage',
        component: () => import('../views/serverMonitor/manageFile/manage.vue')
      },
      {
        // 事件——概况
        path: 'eventOver',
        name: 'eventOver',
        component: () => import('../views/serverMonitor/eventFile/eventOver.vue')
      }
    ]
  },
  {
